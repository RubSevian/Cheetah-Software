...
The orientation of the robot in space has been corrected because when walking it swayed very much from side to side

Added a model view from the simulator with visualization
```
